  ...
  try {
    ...
    return NextResponse.json({
      user: {
        ...
        plan: updated.plan,
        plan_source: updated.plan_source ?? null,
        credits_used: updated.credits_used,
        credits_total: updated.credits_total,
        monthly_wallet_balance: Number(updated.monthly_wallet_balance ?? 0),
        extra_wallet_balance: Number(updated.extra_wallet_balance ?? 0),
        wallet_spent: Number(updated.wallet_spent ?? 0),
        wallet_balance: Number(updated.monthly_wallet_balance ?? 0) + Number(updated.extra_wallet_balance ?? 0),
        ...
        billing_cycle_end: updated.billing_cycle_end ?? null,
