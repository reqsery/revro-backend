...
- Studio task item shape: { "task_type": "CREATE_UI|INSERT_SCRIPT|CREATE_FOLDER|CREATE_REMOTE_EVENT|CREATE_MODULE_SCRIPT|INSERT_INSTANCE|APPLY_PROPERTIES|READ_EXPLORER|READ_OUTPUT|APPLY_IMAGE", "data": { ... } }
